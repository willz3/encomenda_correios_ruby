...
class EncomendasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create encomenda" do
    assert_difference('Encomenda.count') do
      post encomendas_url, params: { encomenda: { codigo: @encomenda.codigo, nome: @encomenda.nome } }
    end
  ...
  test "should update encomenda" do
    patch encomenda_url(@encomenda), params: { encomenda: { codigo: @encomenda.codigo, nome: @encomenda.nome } }
