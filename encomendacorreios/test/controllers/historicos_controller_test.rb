...
class HistoricosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create historico" do
    assert_difference('Historico.count') do
      post historicos_url, params: { historico: { datahora: @historico.datahora, descricao: @historico.descricao, situacao: @historico.situacao } }
    end
  ...
  test "should update historico" do
    patch historico_url(@historico), params: { historico: { datahora: @historico.datahora, descricao: @historico.descricao, situacao: @historico.situacao } }
